# This module defines SQLite adapters to convert numpy data types to SQLite
# supported plain data types.
# Only needs to be imported so that it is executed once.
import sqlite3
import numpy as np
...
def adapt_np_maskedconstant(np_masked): return
...
sqlite3.register_adapter(np.ma.core.MaskedConstant, adapt_np_maskedconstant)
